...
# import compilerneutralatomcompilation as NAC
from .compiler import Compiler
...
class LookaheadCompilerConstrained(Compiler):
    ...
    def __init__(self, interaction_model, hardware, constrained_method="wide") -> None:
    ...
    def _initial_mapping(self, circuit, dist_dict, frontier, weighting_function):
        ...
        self.viable_nodes_sets = self.hardware.get_constrained_qubit_sets(
            len(circuit.qubits), self.constrained_method
        )
    ...
    def compile(
        ...
        if l2p is None:
            print("no mapping")
            return None
        return self._schedule_and_route(
