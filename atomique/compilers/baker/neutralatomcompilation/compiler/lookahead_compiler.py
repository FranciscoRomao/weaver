...
import compilers.baker.neutralatomcompilation as NAC
from compilers.baker.neutralatomcompilation.compiler import Compiler


class LookaheadCompiler(Compiler):
    ...
    def _initial_mapping(self, dist_dict, frontier, weighting_function):
        ...
        try:
            center_qubit = nx.center(self.interaction_model.interaction_graph)[0]
        except:
            return None, None
