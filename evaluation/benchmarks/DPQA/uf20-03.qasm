...
u3(pi/2,0,pi) q[6];
cz q[0],q[6];
u3(pi,-0.21666401,2.9249286) q[0];
u3(pi,-3.1176114,0.023981213) q[6];
u3(pi,-1.7350097,1.406583) q[7];
cz q[0],q[7];
u3(pi,1.2490458,1.2490458) q[0];
u3(pi/2,-0.54604225,0) q[7];
cz q[7],q[15];
u3(2.9595786,pi/2,-pi/2) q[15];
cz q[7],q[15];
u3(0,1.406583,-1.406583) q[15];
...
cz q[1],q[5];
u3(pi,-2.2455373,-2.2455373) q[1];
u3(pi,-1.2516061,1.8899866) q[4];
cz q[2],q[4];
u3(0,1.6547837,1.486809) q[2];
u3(pi/2,2.7775645,-pi) q[4];
cz q[4],q[8];
...
u3(pi,3.1273283,-0.014264336) q[8];
...
u3(2.9595786,pi/2,-pi/2) q[14];
cz q[9],q[14];
u3(0,-0.46127334,0.46127334) q[14];
u3(pi/2,0,pi) q[9];
cz q[1],q[9];
cz q[1],q[11];
u3(2.9595786,pi/2,-pi/2) q[11];
...
u3(pi,-1.406583,1.7350097) q[2];
cz q[2],q[8];
u3(pi,2.8528056,2.8528056) q[2];
u3(pi,-1.7350097,1.406583) q[6];
u3(pi/2,-0.91007041,0) q[8];
cz q[8],q[12];
u3(2.9595786,-pi/2,pi/2) q[12];
cz q[8],q[12];
u3(0,1.406583,-1.406583) q[12];
...
cz q[5],q[13];
u3(0,1.406583,-1.406583) q[13];
u3(pi,-0.21666401,2.9249286) q[5];
cz q[5],q[14];
u3(pi/2,-0.54604225,0) q[14];
cz q[14],q[15];
u3(2.9595786,pi/2,-pi/2) q[15];
cz q[14],q[15];
u3(pi/2,0,pi) q[14];
u3(0,1.406583,-1.406583) q[15];
u3(pi,1.2490458,1.2490458) q[5];
cz q[5],q[14];
u3(0,1.406583,-1.406583) q[14];
cz q[5],q[15];
u3(0.36402816,pi/2,-pi/2) q[15];
...
u3(0,-pi,-pi) q[6];
cz q[6],q[15];
u3(pi/2,2.4135363,-pi) q[15];
cz q[15],q[18];
u3(2.9595786,pi/2,-pi/2) q[18];
cz q[15],q[18];
u3(pi/2,0,pi) q[15];
u3(0,1.406583,-1.406583) q[18];
u3(0,2.1815223,0.96007036) q[6];
cz q[6],q[15];
u3(0,1.406583,-1.406583) q[15];
u3(0,-pi,-pi) q[6];
cz q[6],q[16];
...
cz q[9],q[15];
u3(0,-0.46127334,0.46127334) q[15];
cz q[11],q[15];
u3(pi,1.0601307,-2.081462) q[11];
...
cz q[13],q[16];
cz q[13],q[17];
u3(2.0596338,2.887747,1.0660546) q[16];
u3(2.9595786,-pi/2,pi/2) q[17];
cz q[13],q[17];
cz q[13],q[18];
u3(0,1.406583,-1.406583) q[17];
