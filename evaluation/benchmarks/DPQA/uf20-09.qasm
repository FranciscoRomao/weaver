...
qreg q[20];
creg meas[20];
u3(pi/2,-1.8321345,0) q[0];
u3(pi/2,1.0797238,-pi) q[1];
u3(pi/2,-2.1022066,0) q[2];
u3(pi,1.88963,-1.2519627) q[3];
cz q[0],q[3];
u3(pi,-2.5640398,2.9557296) q[0];
...
u3(pi/2,0,pi) q[6];
cz q[0],q[6];
u3(pi,-0.29755781,2.8440348) q[0];
cz q[0],q[9];
u3(pi,-0.35205556,-0.35205556) q[0];
u3(0,1.406583,-1.406583) q[6];
...
u3(pi,-0.0012588532,3.1403338) q[5];
cz q[2],q[5];
u3(pi,0.68857946,2.0627297) q[2];
...
u3(pi/2,0,pi) q[6];
cz q[4],q[6];
u3(pi,-2.8126403,0.32895233) q[4];
u3(0,1.406583,-1.406583) q[6];
cz q[5],q[6];
u3(2.9595786,pi/2,-pi/2) q[6];
cz q[5],q[6];
...
u3(pi,-3.1176114,0.023981213) q[7];
cz q[4],q[7];
u3(pi,0.83847728,0.83847728) q[4];
u3(pi/2,-2.4135363,0) q[7];
...
u3(pi/2,0,pi) q[12];
u3(0,1.406583,-1.406583) q[15];
u3(pi,0.95054684,-2.1910458) q[4];
cz q[4],q[12];
u3(pi,-1.7350097,1.406583) q[12];
cz q[4],q[15];
u3(pi/2,0,pi) q[15];
...
u3(pi/2,0,pi) q[16];
u3(pi,-1.7350097,1.406583) q[17];
u3(pi,0.95054684,-2.1910458) q[6];
cz q[6],q[16];
u3(0,1.406583,-1.406583) q[16];
u3(0,-pi,-pi) q[6];
cz q[6],q[17];
...
cz q[10],q[12];
u3(pi,1.3702144,1.3702144) q[10];
...
cz q[12],q[18];
u3(pi,0.95054684,-2.1910458) q[12];
...
u3(1.8985957,0.16125694,-1.1029602) q[19];
