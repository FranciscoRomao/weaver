...
u3(pi/2,0,pi) q[10];
cz q[1],q[10];
u3(pi,-0.21666401,2.9249286) q[1];
cz q[1],q[11];
u3(pi,1.2490458,1.2490458) q[1];
u3(pi,-3.1176114,0.023981213) q[10];
...
cz q[3],q[7];
u3(0,-pi,-pi) q[3];
u3(0,-0.46127334,0.46127334) q[7];
cz q[4],q[7];
u3(pi,1.1831673,-1.9584254) q[4];
...
cz q[10],q[11];
u3(pi/2,0,pi) q[10];
u3(pi,3.1273283,-0.014264336) q[11];
u3(0,1.1071487,2.0344439) q[6];
cz q[6],q[10];
u3(0,1.406583,-1.406583) q[10];
u3(pi,-1.406583,1.7350097) q[6];
cz q[6],q[11];
u3(pi/2,-0.91007041,0) q[11];
cz q[11],q[13];
...
u3(2.3659483,2.6392966,0.91503045) q[19];
