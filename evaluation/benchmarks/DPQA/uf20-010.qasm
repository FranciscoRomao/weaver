...
qreg q[20];
creg meas[20];
u3(pi/2,-2.8671113,-pi) q[0];
u3(pi,2.9486403,-0.1929524) q[1];
cz q[0],q[1];
u3(0,1.3638629,0.95720624) q[0];
...
cz q[0],q[4];
u3(pi,-2.4439284,0.69766426) q[0];
...
u3(0,-pi,-pi) q[1];
cz q[1],q[10];
u3(0,-0.95930733,0.95930733) q[1];
...
u3(pi/2,0,pi) q[13];
u3(0,1.406583,-1.406583) q[18];
u3(0,-0.83881661,0.83881661) q[8];
cz q[8],q[13];
u3(0,1.406583,-1.406583) q[13];
cz q[8],q[14];
u3(pi/2,0,pi) q[14];
