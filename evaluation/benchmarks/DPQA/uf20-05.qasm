...
qreg q[20];
creg meas[20];
u3(pi/2,3.0309401,0) q[0];
u3(0,-pi,-pi) q[1];
cz q[0],q[1];
u3(pi,0.87683469,0.98748727) q[0];
...
u3(2.9595786,pi/2,-pi/2) q[15];
cz q[14],q[15];
u3(1.4063724,-3.0631743,1.123221) q[15];
u3(2.9595786,-pi/2,pi/2) q[16];
cz q[12],q[16];
u3(0,1.406583,-1.406583) q[16];
cz q[13],q[16];
