...
qreg q[20];
creg meas[20];
u3(pi/2,2.6758356,0) q[0];
u3(pi/2,0.83992176,0) q[1];
u3(pi,2.9486403,-0.1929524) q[2];
cz q[0],q[2];
u3(pi,2.5859761,-1.9573536) q[0];
...
u3(0,-pi,-pi) q[0];
cz q[0],q[3];
u3(0,1.9984723,1.1431203) q[0];
u3(pi,-1.7350097,1.406583) q[2];
cz q[1],q[2];
u3(pi,0.92061769,0.080695924) q[1];
u3(pi/2,2.7775645,0) q[2];
cz q[2],q[5];
u3(pi/2,2.4135363,-pi) q[3];
cz q[3],q[4];
u3(2.9595786,pi/2,-pi/2) q[4];
cz q[3],q[4];
...
cz q[17],q[18];
u3(1.0819589,-2.887747,1.0660546) q[18];
u3(0,1.406583,-1.406583) q[19];
cz q[13],q[19];
u3(2.9595786,-pi/2,pi/2) q[19];
cz q[13],q[19];
...
u3(1.7352202,3.0631743,1.123221) q[19];
