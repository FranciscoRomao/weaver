...
qreg q[20];
creg meas[20];
u3(pi/2,-2.4982716,-pi) q[0];
cz q[0],q[1];
u3(0,-2.9147502,1.3613587) q[0];
...
u3(0,-0.46127334,0.46127334) q[5];
...
u3(0,-pi,-pi) q[7];
cz q[7],q[14];
u3(pi/2,2.4135363,-pi) q[14];
cz q[14],q[18];
u3(2.9595786,-pi/2,pi/2) q[18];
cz q[14],q[18];
u3(pi/2,0,pi) q[14];
u3(0,1.406583,-1.406583) q[18];
u3(0,2.1815223,0.96007036) q[7];
cz q[7],q[14];
u3(0,1.406583,-1.406583) q[14];
cz q[7],q[15];
u3(2.9595786,pi/2,-pi/2) q[15];
...
u3(pi,-1.7350097,1.406583) q[12];
cz q[11],q[12];
u3(0,0.98697086,2.1546218) q[11];
u3(pi/2,0.18201408,-pi) q[12];
u3(0,1.406583,-1.406583) q[13];
cz q[10],q[13];
u3(pi/2,0,pi) q[13];
