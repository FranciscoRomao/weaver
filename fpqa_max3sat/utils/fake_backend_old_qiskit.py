...
from qiskit.circuit.controlflow import IfElseOp, WhileLoopOp, ForLoopOp, BreakLoopOp, ContinueLoopOp
...
class NoisyFakeBackend(FakeBackendV2):
    def __init__(
        self,
        num_qubits: int,
        ...
        *,
        ...
        dtm: float | None = None,
        seed: int | None = None,
        noise_settings: dict | None = _NOISE_DEFAULTS,
    ):
